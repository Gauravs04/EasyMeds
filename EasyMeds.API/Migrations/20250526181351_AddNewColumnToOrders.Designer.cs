...
namespace EasyMeds.API.Migrations
{
    ...
    [Migration("20250526181351_AddNewColumnToOrders")]
    partial class AddNewColumnToOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Drugs", b =>
                {
            ...
            modelBuilder.Entity("API.Models.SalesReport", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Models.Inventory", b =>
                {
                    b.HasOne("API.Models.Drugs", "Drugs")
                        .WithMany("Inventory")
            ...
            modelBuilder.Entity("API.Models.OrderItems", b =>
                {
                    ...
                    b.HasOne("API.Models.Orders", "Orders")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("API.Models.Orders", b =>
                {
                    b.HasOne("API.Models.TransactionDetails", "TransactionDetails")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("API.Models.SalesReport", b =>
                {
                    b.HasOne("API.Models.Orders", "Order")
                        .WithOne("SalesReport")
                        .HasForeignKey("API.Models.SalesReport", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
