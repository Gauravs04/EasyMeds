...
export class UsersComponent {
  ...
  constructor(private userService: UsersService , private snackbar: MatSnackBar , private apiService : ApiService,private authService:AuthService) {}
  ...
  fetchUsers() {
    ...
    this.userService.getAllUsers().subscribe({
      next: (res) => this.users = res.filter((s: { userId: string })=>s.userId!==userid),
